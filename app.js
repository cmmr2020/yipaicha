 ...
 wxRequest(method, url, data,seesionid, callback, errFun) {
  ...
  getRecordAuth: function () {
    ...
    userInfo: null,
      ...
      requestUrl:'https://testwx.diaochaonline.com'//35域名
     //requestUrl: 'https://wx.diaochaonline.com'//线上
  },
  msgData:{
    m_10001:'抱歉，因为您之前的不规范操作，现已将您拉入黑名单，因此无法继续使用 “易拍查”小程序，进行不文明现象上报！',
    m_10002:'抱歉，您所在城市不在当前项目的执行城市范围之内，无法继续使用 “易拍查”小程序，进行不文明现象上报！',
    m_10003:'抱歉，您未授权获取您的地理位置，因此无法继续使用 “易拍查”小程序，进行不文明现象上报！请根据引导开启获取位置权限再试~',
    m_10004:'抱歉，您所在地区区域暂未开启“易拍查”相关活动,无法进行不文明现象上报！',
    m_10005:'抱歉，您所属组织状态已设为无效,无法进行不文明现象上报!请联系管理员恢复。',
    m_10006:'抱歉，未找到您所属的项目信息,请扫描小程序码重新进入。',
